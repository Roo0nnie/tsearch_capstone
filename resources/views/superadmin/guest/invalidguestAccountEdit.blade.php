                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                        ...
                                        value="{{ old('email', $invalidfaculty->email) }}" required autocomplete="email">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select class="form-select @error('status') is-invalid @enderror" id="status"
                                        ...
                                        <option value="Active"
                                            {{ old('status', $invalidfaculty->status) == 'Active' ? 'selected' : '' }}>
                                            Active</option>
                                        <option value="Inactive"
                                            {{ old('status', $invalidfaculty->status) == 'Inactive' ? 'selected' : '' }}>
                                            Deactive</option>
                                    </select>
                                    @error('status')
                                        <span class="invalid-feedback" role="alert">
