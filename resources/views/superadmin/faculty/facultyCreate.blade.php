                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.faculty.store') }}">
                            ...
                            <div class="row mb-3">
                                <label for="user_code"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Faculty ID') }}</label>
                            ...
                            <input id="type" type="hidden" class="form-control @error('type') is-invalid @enderror"
                                name="type" value="faculty" required autocomplete="type" autofocus>

                            <input id="status" type="hidden"
                                class="form-control @error('status') is-invalid @enderror" name="status" value="offline"
