                ...
                <div class="accordion faq-accordion" id="faqAccordion">
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header" id="faqHeading1">
                            <button class="accordion-button" type="button" data-ui-toggle="collapse"
                                data-ui-target="#faqCollapse1" aria-expanded="true" aria-controls="faqCollapse1">
                                What is TSearch?
                            </button>
                        </h2>
                        <div id="faqCollapse1" class="accordion-collapse collapse show" aria-labelledby="faqHeading1"
                            data-ui-parent="#faqAccordion">
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header" id="faqHeading2">
                            <button class="accordion-button collapsed" type="button" data-ui-toggle="collapse"
                                data-ui-target="#faqCollapse2" aria-expanded="false" aria-controls="faqCollapse2">
                                Who can use TSearch?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header" id="faqHeading4">
                            <button class="accordion-button collapsed" type="button" data-ui-toggle="collapse"
                                data-ui-target="#faqCollapse4" aria-expanded="false" aria-controls="faqCollapse4">
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header" id="faqHeading5">
                            <button class="accordion-button collapsed" type="button" data-ui-toggle="collapse"
                                data-ui-target="#faqCollapse5" aria-expanded="false" aria-controls="faqCollapse5">
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header" id="faqHeading6">
                            <button class="accordion-button collapsed" type="button" data-ui-toggle="collapse"
                                data-ui-target="#faqCollapse6" aria-expanded="false" aria-controls="faqCollapse6">
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header" id="faqHeading7">
                            <button class="accordion-button collapsed" type="button" data-ui-toggle="collapse"
                                data-ui-target="#faqCollapse7" aria-expanded="false" aria-controls="faqCollapse7">
                    ...
                    <div class="accordion-item mb-3">
                        <h2 class="accordion-header" id="faqHeading8">
                            <button class="accordion-button collapsed" type="button" data-ui-toggle="collapse"
                                data-ui-target="#faqCollapse8" aria-expanded="false" aria-controls="faqCollapse8">
