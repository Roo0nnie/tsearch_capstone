...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById("faculty-selected").addEventListener("click", () => {
                const rowCheckboxes = document.querySelectorAll(".row-checkbox");
                ...
                Swal.fire({
                    title: "Are you sure?",
                    text: "You are about to change it user status. This action cannot be undone!",
                    icon: "warning",
                    ...
                    if (result.isConfirmed) {
                        fetch('/admin/changeStatus_status', {
                            ...
                            .then(data => {
                                Swal.fire("Status Change!",
                                    "The selected items has been change.",
                                    "success");
                                location.reload();
                            })
                            .catch(error => {
                                ...
                                Swal.fire("Error!",
                                    "An error occurred while changing status the items.",
                                    "error");
                            });
                    }
                });
