            ...
            <div class="page-inner">
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex justify-content-start">
                        ...
                        <form id="dynamicFieldsContainer_published" action="{{ route('report.generation.file.upload') }}"
                ...
                <div class="mt-3">
                    <div class="card table-responsive">
                        <div class="card-body">
                            <div class="container">
                                <div>
                                    <h3 class="fw-bold mb-3">File Upload</h3>
                                </div>
                                <div id="">
                                    <table id="report-file-upload" class="display table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Category</th>
